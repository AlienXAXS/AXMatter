data:extend({
{
    ...
    stages =
    {
      sheet =
      {
        filename = "__ax_matter__/graphics/entity/matter-iron-ore/matter-iron-ore.png",
        priority = "extra-high",
        width = 64,
        height = 64,
        frame_count = 8,
        ...
        hr_version =
        {
          filename = "__ax_matter__/graphics/entity/matter-iron-ore/hr-matter-iron-ore.png",
          priority = "extra-high",
          width = 128,
          height = 128,
          frame_count = 8,
